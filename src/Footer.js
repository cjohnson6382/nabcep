...
const Footer = () => (
	<div style={ { borderLeft: "1em solid #f05401", background: "#656363", padding: "1em", display: "flex", justifyContent: "center", alignItems: "Center", flexDirection: "row", color: "white" } } >
		<h1 style={ { zIndex: 2, position: "absolute", alignItems: "center", justifyContent: "center", opacity: "0.5", color: "white", fontWeight: "bold" } } >THE FOOTER IS ALL STATIC PLACEHOLDER CONTENT</h1>
